...
interface AddDepartmentViewProps {
  onSave: (name: string) => void;
  onCancel: () => void;
}

export const AddDepartmentView: React.FC<AddDepartmentViewProps> = ({ onSave, onCancel }) => {
  ...
  return (
    <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-6 max-w-5xl mx-auto my-4 text-xs text-slate-700 font-sans">
      <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-6">
        <h2 className="text-base font-bold text-slate-800">Add Department</h2>
        <button
          onClick={onCancel}
